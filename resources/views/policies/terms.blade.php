...
<html lang="{{ config('app.locale') }}">
    <head>
        ...
        <title>{{ config('app.name', 'Talent Guru') }} - Terms & Conditions</title>
        <!-- Styles -->
                    ...
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <section class="spaced2">                                
                                <h3 class="text-center" style="margin-top: 0">Terms and conditions</h3>

                                <p>These terms and conditions ("Terms", "Agreement") are an agreement between Website Operator ("Website Operator", "us", "we" or "our") and you ("User", "you" or "your"). This Agreement sets forth the general terms and conditions of your use of the <a target="_blank" rel="nofollow" href="https://talentguru.africa">https://talentguru.africa</a> website and any of its products or services (collectively, "Website" or "Services").</p>
                                ...
                                <p>The formation, interpretation and performance of this Agreement and any disputes arising out of it shall be governed by the substantive and procedural laws of Nairobi, Kenya without regard to its rules on conflicts or choice of law and, to the extent applicable, the laws of Kenya. The exclusive jurisdiction and venue for actions related to the subject matter hereof shall be the state and federal courts located in Nairobi, Kenya, and you hereby submit to the personal jurisdiction of such courts. You hereby waive any right to a jury trial in any proceeding arising out of or related to this Agreement. The United Nations Convention on Contracts for the International Sale of Goods does not apply to this Agreement.</p>
